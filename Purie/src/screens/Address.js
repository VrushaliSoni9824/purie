          ...
          body: JSON.stringify({
           ...
           .then((responseData) => {
               ...
               if (responseData.status) {
                   //    alert(reduxUser.customer.userId);
                   //  // console.log(responseData.user_address.customer);
                   responseData.user_address.map((data) => {
                       // alert(data.flat);
                       setFrmFlat(data.flat);
                       setFrmBlock(data.block);
                       setFrmSociety(data.society);
                       setFrmZip(data.zip);
                       setFrmCity(data.city);
                       setFrmState(data.state);
                       setFrmCountry(data.country);
                       setFrmLandmark(data.landmark);
                   })
        ...
        <MemberHeader title="Address"/>
            ...
            <View style={styles.form}> 
                ...
                
                    {
                        ...
                        <Text style={styles.getstartText}>Save Detail</Text>
